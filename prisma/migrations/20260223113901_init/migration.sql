...
CREATE TABLE `AdminConfig` (
    ...
    `minRequiredVersion` VARCHAR(191) NULL,
    `latestVersion` VARCHAR(191) NULL,
    `mandatoryUpdateMessage` VARCHAR(191) NULL,
    `notificationUpdateMessage` VARCHAR(191) NULL,
    `playStoreLink` VARCHAR(191) NULL,
    `appStoreLink` VARCHAR(191) NULL,
...
CREATE TABLE `SwordSynthesisRequirement` (
    ...
    INDEX `SwordSynthesisRequirement_swordLevelDefinitionId_idx`(`swordLevelDefinitionId`),
...
CREATE TABLE `SwordUpgradeDrop` (
    ...
    INDEX `SwordUpgradeDrop_swordLevelDefinitionId_idx`(`swordLevelDefinitionId`),
