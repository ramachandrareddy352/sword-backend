...
const getUserFullDetails = async (req, res) => {
    try {
        ...
        const user = await (0, queryHelpers_ts_1.resolveUser)({
            id: undefined,
        ...
        const marketplacePurchases = await client_ts_1.default.marketplacePurchase.findMany({
            where: { userId: user.id },
            include: {
                marketplaceItem: {
                    select: {
        ...
        const customerSupports = await client_ts_1.default.customerSupport.findMany({
            where: { userId: user.id },
            orderBy: { createdAt: "desc" },
        });
        return res.status(200).json({
            ...
            user: (0, serializeBigInt_ts_1.serializeBigInt)(safeUser),
            vouchers: { list: (0, serializeBigInt_ts_1.serializeBigInt)(vouchers), total: vouchers.length },
            swords: { list: (0, serializeBigInt_ts_1.serializeBigInt)(swords), total: swords.length },
            materials: { list: (0, serializeBigInt_ts_1.serializeBigInt)(materials), total: materials.length },
            shields: { list: (0, serializeBigInt_ts_1.serializeBigInt)(shields), total: shields.length },
            gifts: { list: (0, serializeBigInt_ts_1.serializeBigInt)(gifts), total: gifts.length },
            marketplacePurchases: {
                list: (0, serializeBigInt_ts_1.serializeBigInt)(marketplacePurchases),
                total: marketplacePurchases.length,
            },
            customerSupports: {
                list: (0, serializeBigInt_ts_1.serializeBigInt)(customerSupports),
...
const getUserBasicInfo = async (req, res) => {
    try {
        ...
        return res.status(200).json({
            ...
            data: (0, serializeBigInt_ts_1.serializeBigInt)(safeUser),
        });
    }
    catch (err) {
...
const getUserSwords = async (req, res) => {
    try {
        ...
        await (0, queryHelpers_ts_1.resolveUser)({
            id: userId ? String(userId) : undefined,
            email: undefined,
        });
        /* ---------------- WHERE ---------------- */
...
const getUserGifts = async (req, res) => {
    try {
        ...
        return res.status(200).json({
            ...
            data: (0, serializeBigInt_ts_1.serializeBigInt)(gifts),
            total: gifts.length,
        });
    }
    catch (err) {
...
const getUserCustomerSupports = async (req, res) => {
    try {
        ...
        const complaints = await client_ts_1.default.customerSupport.findMany({
            where,
            ...(orderBy.length > 0 ? { orderBy } : {}),
        });
        return res.status(200).json({
            ...
            data: (0, serializeBigInt_ts_1.serializeBigInt)(complaints),
